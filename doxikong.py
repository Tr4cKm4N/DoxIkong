...
#~~~~~~~~~~~ INFO ~~~~~~~~~~~~
#
#     Simple herramienta para Doxing
#
#*****************************
...
def signal_handler(signal, frame):
		KURO()
		LOGO()
		print('\033[1;m [\033[1;31mX\033[1;m] Precionaste Ctrl+C!')
		time.sleep(2)
		EXITMENU()
...
| $$    $$ \$$    $$|  $$ \$$\|   $$ \| $$  \$$\ \$$    $$| $$  | $$ \$$    $$
 \$$$$$$$   \$$$$$$  \$$   \$$ \$$$$$$ \$$   \$$  \$$$$$$  \$$   \$$ _\$$$$$$$
     ...
     \033[1;31mDoxIkong\033[1;m \033[1;34mETH:\033[1;m Recopilacion de informacion \033[1;33mVersion:\033[1;32m Beta 1.0\033[1;35m
     """
...
def menu():
	...
	time.sleep(1) 
	print """
\033[1;33m    	1.\033[1;m Nombre
\033[1;33m     	2.\033[1;m Numero Celular
...
\033[1;36m       99. About
	...
	if OPT == "1":
		...
		KURO()
		LOGO()
		print "\033[1;31m[ERROR]\033[1;m seleccion Invalida!"
		time.sleep(3)
		menu()
...
\033[1;36m   99. Back\033[1;31m  0. Exit
	...
	if Tracker == "1":
		...
		KURO()
		LOGO() 
		print "\033[1;31m[ERROR]\033[1;m selecion Invalida!"
		time.sleep(3)
		menu()
...
def DEAD():
	...
	F_name = raw_input("\033[1;35m Primer Apellido:\033[1;m ")
...
\033[1;36m    99. Back\033[1;31m    0. Exit
	...
	if Tracker == "1":
		...
		KURO()
		LOGO()
		print "\033[1;31m[ERROR]\033[1;m seleccion Invalido!"
		time.sleep(3)
		menu()
...
def EXITMENU():
	...
	LOGO()
	time.sleep(1)
	print "\033[1;m Gracias por usar DoxIkong\033[1;m"
	time.sleep(2)
	print
	print "\033[1;m[\033[1;31mX\033[1;m]...\033[1;32mCerrando"
	time.sleep(1)
	KURO()
	sys.exit()
